...
},{"./../infra/api":4,"@babel/runtime/helpers/asyncToGenerator":8,"@babel/runtime/helpers/interopRequireDefault":9,"@babel/runtime/helpers/typeof":13,"@babel/runtime/regenerator":16}],4:[function(require,module,exports){
"use strict";
...
function loadActivityByMonthAndYear(_x, _x2) {
  return _loadActivityByMonthAndYear.apply(this, arguments);
}

function _loadActivityByMonthAndYear() {
  _loadActivityByMonthAndYear = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2($month, $year) {
    var result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return activityRepository.getActivitiesByMonthAndYear($month, $year);
...
function getDetailActivityFromResult(result, id, dataMonthAndYear) {
  ...
  detailActivity["month"] = dataMonthAndYear["month"]; //get score
  ...
  detailActivity["score"] = score; //get left

  var left = detailActivity["target"] - score; //fill left
...
function showActivitiesSummary(activities) {
  ...
  console.log(activities); //show report summary activity and hide report detail activity

  $(".report-summary-activity").show();
  $(".report-detail-activity").hide(); //clear histories

  $(".report-summary-activity .data-activity-summary").empty(); //prepare template

  var rowActivitySummaryTpl = $('script[data-template="row-activity-summary"').text(); //render html
...
function showDetailActivity(detailActivity) {
  console.log("check data");
  console.log(detailActivity); //show report detail activity and hi hide report summary activity

  $(".report-summary-activity").hide();
  $(".report-detail-activity").show(); //clear report heading, data report detail, footer report detail

  $(".report-detail-activity .report-heading").remove();
  $(".report-detail-activity .data-report-detail-activity").empty();
  $(".report-detail-activity .total-report-detail-activity").empty(); //prepare template
  ...
  var rowFooterReportDetailActivityTpl = $('script[data-template="row-footer-report-detail-activity"').text(); //render html
  //- render heading
...
jQuery( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var dataMonthAndYear, result, activitiesSummary;
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          dataMonthAndYear = getMonthAndYearFromUrlParameter();
          _context.next = 3;
          return loadActivityByMonthAndYear(dataMonthAndYear["month"], dataMonthAndYear["year"]);

        case 3:
          result = _context.sent;

          if (result['success']) {
            activitiesSummary = getActivitiesSummaryFromResult(result["response"]["data"]);
...
},{"./../../../js/app/data/activity_repository":3,"./../core/datetime_helper":1,"./../core/template_helper":2,"@babel/runtime/helpers/asyncToGenerator":8,"@babel/runtime/helpers/interopRequireDefault":9,"@babel/runtime/helpers/typeof":13,"@babel/runtime/regenerator":16}],6:[function(require,module,exports){
