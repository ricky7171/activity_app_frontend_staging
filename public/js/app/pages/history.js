...
function loadHistoriesData() {
  return _loadHistoriesData.apply(this, arguments);
}

function _loadHistoriesData() {
  _loadHistoriesData = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
    var result;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
...
function showHistoriesData(histories) {
  ...
  console.log(histories); //clear histories

  $(".list-history").empty(); //prepare template

  var rowHistoriesTpl = $('script[data-template="row-history"').text(); //generate row history, then put it on .list-history
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return loadHistoriesData();

        case 2:
          historiesData = _context2.sent;
          ...
          $("body").on('click', '.btn-delete-history', /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
            ...
            return _regenerator.default.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return deleteHistory($(this).attr("historyId"));
...
},{"./../../../js/app/data/history_repository":3,"./../core/template_helper":2,"@babel/runtime/helpers/asyncToGenerator":8,"@babel/runtime/helpers/interopRequireDefault":9,"@babel/runtime/helpers/typeof":13,"@babel/runtime/regenerator":16}],6:[function(require,module,exports){
