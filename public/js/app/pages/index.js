...
},{"./../core/datetime_helper":2,"./../infra/api":6,"@babel/runtime/helpers/asyncToGenerator":10,"@babel/runtime/helpers/interopRequireDefault":11,"@babel/runtime/helpers/typeof":15,"@babel/runtime/regenerator":18}],6:[function(require,module,exports){
"use strict";
...
},{"@babel/runtime/helpers/asyncToGenerator":10,"@babel/runtime/helpers/interopRequireDefault":11,"@babel/runtime/helpers/slicedToArray":14,"@babel/runtime/regenerator":18}],7:[function(require,module,exports){
"use strict";
...
function _addHistory() {
  _addHistory = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(activityId, inputValue, useTextfield) {
    var result;
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return historyRepository.addHistory(activityId, inputValue, useTextfield);
...
function showActivitiesData(activities) {
  ...
  console.log(activities); //clear activities 

  $(".report-wrapper").empty(); // prepare template
  ...
  var disabledValueActivityTpl = $('script[data-template="disabled-value-activity-template"').text(); //prepare content activity row for float value
  ...
  $(".report-wrapper").append(activities.map(function (activityData, i) {
    ...
    if (activityData["use_textfield"] == false) {
      ...
      indexActivityRowFloat += 1; //if it's even, then it should clear contentActivityRowFloat first
      ...
      if (contentActivityRowFloat["value_activity_left_side_html"] != "") {
        //it means, it should fill right side, after that, insert to report-wrapper
      ...
      if (contentActivityRowFloat["value_activity_left_side_html"] == "") {
        //it means, it should fill left side first
      ...
      //if this activity USE textfield, then save on the temporary variable, and render it later
  ...
  }).join('')); //render list activity that use float
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"./arrayWithHoles.js":9,"./iterableToArrayLimit.js":12,"./nonIterableRest.js":13,"./unsupportedIterableToArray.js":16}],15:[function(require,module,exports){
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"./arrayLikeToArray.js":8}],17:[function(require,module,exports){
/**
